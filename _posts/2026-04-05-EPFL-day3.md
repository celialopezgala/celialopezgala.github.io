...
<div style="text-align: center;">
  <video width="50%" controls muted>
    <source src="assets/img/Distance sensor.mp4" type="video/mp4">
  </video>
  <br>
...
<div style="text-align: center; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="assets/img/Message Display.mp4" type="video/mp4">
  </video>
  <br>
</div>
...
<div style="text-align: center; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="assets/img/Basic Movement.mp4" type="video/mp4">
  </video>
</div>
...
<div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="assets/img/Radio Controlled Robot.mp4" type="video/mp4">
  </video>

  <video width="50%" controls muted>
    <source src="assets/img/Day 3 Car.mp4" type="video/mp4">
  </video>
</div>
