...
<div style="text-align: center;">
  <video width="50%" controls muted>
    <source src="assets/img/DistancesSensor.mp4" type="video/mp4">
  </video>
  <br>
...
<div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="assets/img/RadioControlledRobot.mp4" type="video/mp4">
  </video>

  <video width="50%" controls muted>
    <source src="assets/img/Day3Car.mp4" type="video/mp4">
  </video>
</div>
