...
<div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="/assets/img/LightDetector.mp4" type="video/mp4">
  </video>

  <video width="50%" controls muted>
    <source src="/assets/img/LightDetectorV2.mp4" type="video/mp4">
  </video>
</div>
...
<div style="text-align: center; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="/assets/img/TrainingModel.mp4" type="video/mp4">
  </video>
</div>
...
<div style="text-align: center; margin-top: 20px;">
  <video width="50%" controls muted>
    <source src="/assets/img/RobotML.mp4" type="video/mp4">
  </video>
</div> 
